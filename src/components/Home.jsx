...
const Home = () => {
  return (
    <section
      className={`bg-[url(./assets/images/star-background.jpg)] bg-no-repeat bg-cover bg-center bg-fixed relative pt-[100px] home min-h-max sm:min-h-full sm:h-[100vh]`}
    >
      <div
        ...
        >
          ...
          <div className="social my-6 gap-8">
            <a
              ...
              target="_blank"
              className="social-link after:bg-white bg-icon text-white"
            >
              <SiLinkedin />
            </a>
            <a
