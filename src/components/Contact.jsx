        ...
        <div className="flex justify-between items-center gap-12 flex-col-reverse sm:flex-row">
          ...
          <div className="w-full sm:w-[75%]">
            ...
            <p className="text-base sm:text-lg text-gray-700 font-medium">
              I enthusiastically welcome conversations about freelancing or
              full-time roles. Please don't hesitate to reach out through your
              preferred communication channel. Let's connect and explore
